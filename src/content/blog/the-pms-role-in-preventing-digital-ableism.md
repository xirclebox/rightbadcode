...
![Two construction workers building a brick wall. The bricks are not aligned correctly and are carelessly placed. There's text that reads, "Just keep coding. We'll fix it later"](../../assets/post-assets/pms-role/brick-wall.png)
